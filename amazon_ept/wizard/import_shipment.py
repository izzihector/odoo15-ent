...
class AmazonInboundImportShipmentWizard(models.TransientModel):
    ...
    def get_list_inbound_shipment_items(self, shipment_id, instance, inbound_shipment_id):
        ...
        kwargs.update({'emipro_api': 'check_amazon_shipment_status_v13', 'amazon_shipment_id': shipment_id})
    ...
    def create_amazon_inbound_shipment(self, results, instance_id, from_warehouse_id, ship_to_address):
        ...
        for result in results:
            ...
            shipment_date_str = shipment_name.split('(')[1].split(')')[0]
            ...
            are_cases_required = True if result.get('AreCasesRequired', {}).get('value', 'false').lower() == 'true' else False
            inbound_shipment = amazon_inbound_shipment_obj.create({
                ...
                'address_id': ship_to_address and ship_to_address.id, 'label_prep_type': label_prep_type,
    ...
    def get_inbound_import_shipment(self, instance, warehouse_id, ship_ids, ship_to_address=False):
        ...
        for shipment_id in shipment_ids:
            ...
            inbound_shipment = self.create_amazon_inbound_shipment(amazon_shipments, instance.id, warehouse_id.id,
                                                                   ship_to_address)
